...
def inverse(x0, y0, z0):
    ...
    if status[0] == 0:
        theta1 = status[1]
        status = angle_yz(
            x0 * cos120 + y0 * sin120, y0 * cos120 - x0 * sin120, z0, theta2
        )
    if status[0] == 0:
        theta2 = status[1]
        status = angle_yz(
            x0 * cos120 - y0 * sin120, y0 * cos120 + x0 * sin120, z0, theta3
        )
    theta3 = status[1]
...
status1, P1, P2, P3 = forward(-10, -20, -15)
print(status1, P1, P2, P3)

status2, th1, th2, th3 = inverse(P1, P2, P3)
print(status2, th1, th2, th3)
